...
<div>
ScanAnime is an anime streaming service i built for fun. It's designed to be used with an API, if you have one this should work well with some modifications to the cache and sorting / filtering systems. Use, modify & tweak, enjoy. The UI is still a work in progress (its rough in places).
</div>
